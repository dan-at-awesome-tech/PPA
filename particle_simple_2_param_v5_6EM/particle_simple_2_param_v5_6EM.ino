//Number of EM
const int EMcount=3;        // number of Electromagnets in PPA, set between 3 and 6
...
//        report= String(irps_number_)+","+String(wait_clicks_) + "," + String(pulse_clicks_);   
        report= String(irps_number_)+","+String(speed_,2) + "," + String(tf,2)+ "," + String(offset,2);      
...
IRPS irps[7] = {
IRPS(0,7,false, interbeam_dist_mm,beam2em_dist_mm,0.0,true),
...
IRPS(4,4,true, interbeam_dist_mm,beam2em_dist_mm,tf,false), 
IRPS(5,5,true, interbeam_dist_mm,beam2em_dist_mm,tf,false), 
IRPS(6,3,true, interbeam_dist_mm,beam2em_dist_mm,tf,false) 
};
//~,1,0,2,4,5,3
//***************************************************************************************
...
if (EM_status ==0) {      // Only do Serial comms at non-critical time
